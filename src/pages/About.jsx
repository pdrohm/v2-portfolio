      ...
      <div className="my-10 flex flex-col items-center justify-center  gap-x-5 md:flex-row md:items-start">
        <div className="flex flex-col gap-y-5 md:w-2/3">
          <p>
            ...
            que ficam na internet. Meu interesse em desenvolvimento web começou
            por volta de 2017, na época em que eu trabalhava como auxiliar de
            escritório e comecei meus estudos em algoritmos e HTML/CSS básico.
          </p>
          <p>
